...
import SkilltiesIconLogo from '@/assets/skillties-logo-icon.webp'
      ...
      <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          {/* <Circle ref={div4Ref} className="size-16"> */}
            {/* <Icons.openai /> */}
            <div ref={div4Ref} className="">
              <img src={SkilltiesIconLogo.src} loading="eager" className="rounded-[24px] absolute top-[45%] left-[45%] z-20 h-20 w-20 block bg-white" alt="Skillties logo." />
            </div>
          {/* </Circle> */}
          <Circle ref={div6Ref}>
            <Icons.zapier />
